...
<div class="card-bg">
  ...
  <div>
      <time class="short">
      ${dateFormated.dia.semana.curto}, ${dateFormated.dia.numerico} <br>
      ${dateFormated.hora}
      </time>
      <time class="full">
      ${dateFormated.dia.semana.longo}, dia ${dateFormated.dia.numerico} de ${dateFormated.mes} às ${dateFormated.hora}
      </time>
    </div>
  </div>  
  `;
